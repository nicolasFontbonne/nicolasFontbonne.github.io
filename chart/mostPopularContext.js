...
function mostPopularContext() {
//<div class="col-lg-10 col-md-10" id="chart"></div>
var h = 300;
var margin = {top: 20, right: 20, bottom: 30, left: 40},
    width = document.getElementById('mostPopularContext').clientWidth - margin.left - margin.right,
    height = h - margin.top - margin.bottom

var svg = d3.select("#mostPopularContext").append("svg").attr("width", document.getElementById('mostPopularContext').clientWidth).attr("height", h),
...
// set the colors
var z = d3.scaleOrdinal().range(["#FEF035","#FBF162","#F8F082","#F1F3E1","#F1F3ED","#F1F3F2"]);
